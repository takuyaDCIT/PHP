...
<header>
	<div class="header_wrapper">
		<a href="../../htdocs/ecsite/item_list.php" class="title">ECサイト</a>&nbsp;→&nbsp;カートページ
...
<?php foreach ($result_list as $value) { ?>	
	<div class="item_detail_wrapper_cart">
		...
		<div class="detail_width center">
			<img src=<?= '../../htdocs/ecsite/item_img/' . h($value['img']); ?>>
		</div>
		<div class="detail_width center">
			<?= h($value['amount']); ?>
			<form method="POST">
...
<div class="show_sum_wrapper">
	...
	<div class="buy_btn_div">
		<form action="../../htdocs/ecsite/purchase.php" method="POST">
