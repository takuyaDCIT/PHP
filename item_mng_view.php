...
<header>
	<div class="header_wrapper">
		<a href="../../htdocs/ecsite/item_mng.php" class="title">ECサイト</a>&nbsp;→&nbsp;商品管理ページ
	</div>
</header>
<main>
<?= $messages; ?><?= $messages_add; ?>
<p class="top_link"><a href="../../htdocs/ecsite/user_mng.php">ユーザ管理ページ</a></p>
<form enctype="multipart/form-data" action="../../htdocs/ecsite/item_mng_execute.php" method="POST">
